...
tkn -n ci pipeline start \
  ...
  --param git-ops-repo-url=git@github.com:${GIT_ORG}/dr-cluster-gitops-apps.git \
  --param gitops-apps-repo-full-name=${GIT_ORG}/dr-cluster-gitops-apps \
  ...
  --workspace name=gitops-repo-secret,secret=dr-cluster-gitops-apps-at-github \
